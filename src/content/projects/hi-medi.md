...
My work on this project focused on the Unity (C#) implementation, building the breathing visualization delivered through the Panacea AR Glasses GTM-200.

이 프로젝트에서는 Unity(C#) 기반 구현을 맡아, Panacea AR Glasses GTM-200을 통해 호흡 과정을 시각적으로 표현하는 작업을 진행했습니다.

- **Engine / Development:** Unity, C#
- **Hardware:** Panacea AR Glasses GTM-200
-->
